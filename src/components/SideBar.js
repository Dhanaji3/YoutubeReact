...
const SideBar = () => {
  ...
  return (
    <div className='mt-3 flex flex-col items-center mx-auto relative'>
      <div className='p-4 hover:bg-gray-200 rounded-full cursor-pointer' onClick={handleClick}>
      {isMenu && <div className='absolute -left-2 -top-3'><MenuBar/></div>}
        <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" focusable="false" aria-hidden="true" ><path d="M21 6H3V5h18v1zm0 5H3v1h18v-1zm0 6H3v1h18v-1z"></path></svg></div>
      <div className='p-4 hover:bg-gray-200 rounded-xl cursor-pointer flex flex-col items-center text-xs '>
      ...
      <div className='py-4 hover:bg-gray-200 rounded-xl cursor-pointer flex flex-col items-center text-xs '>
